...
void main(){
    ...
    void (*f[4])(FILE* ptrF) = {createAccount, deleteAccount, updateAccount, ListAccounts};

    FILE* ptrF = fopen("Data.dat", "wb+");
...
void deleteAccount(FILE* ptrData){
    printf("Elimino account");
}

void updateAccount(FILE* ptrData){
    printf("Aggiorno account");
}
